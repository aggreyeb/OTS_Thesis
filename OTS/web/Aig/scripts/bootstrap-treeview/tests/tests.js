...
;(function () {
	...
	test('Selecting a node', function () {
		...
		ok($('.list-group-item:first').hasClass('node-selected'), 'TreeNode is correctly selected : class "node-selected" added');
		...
		ok(!iconClass || $('.expand-icon:first').hasClass(iconClass), 'TreeNode icon is correct');
	...
	test('Unselecting a node', function () {
		...
		// Has class node-selected
		ok(!$('.list-group-item:first').hasClass('node-selected'), 'TreeNode is correctly unselected : class "node-selected" removed');
		
		// Only one can be selected
		ok(($('.node-selected').length === 0), 'There are no selected nodes');

		// Has correct icon
		ok(!options.nodeIcon || $('.expand-icon:first').hasClass(options.nodeIcon), 'TreeNode icon is correct');
	...
	test('Clicking a non-selectable, collapsed node expands the node', function () {
		...
		ok(!el.hasClass('node-selected'), 'TreeNode should not be selected');
	...
	test('Checking a node', function () {
		...
		$el = $('.check-icon:first');
		ok(($el.attr('class').indexOf(options.checkedIcon) !== -1), 'TreeNode is checked : icon is correct');
	...
	test('Unchecking a node', function () {
		...
		// check state is correct
		$el = $('.check-icon:first');
		ok(($el.attr('class').indexOf(options.uncheckedIcon) !== -1), 'TreeNode is unchecked : icon is correct');
	...
	test('disableNode / enableNode', function () {
		...
		ok($('.list-group-item:first').hasClass('node-disabled'), 'Disable node (by id) : TreeNode has class node-disabled');
		...
		ok(!$('.list-group-item:first').hasClass('node-disabled'), 'Enable node (by id) : TreeNode does not have class node-disabled');
		...
		ok($('.list-group-item:first').hasClass('node-disabled'), 'Disable node (by node) : TreeNode has class node-disabled');
		...
		ok(!$('.list-group-item:first').hasClass('node-disabled'), 'Enable node (by node) : TreeNode does not have class node-disabled');
	...
	test('toggleNodeDisabled', function () {
		...
		ok($('.list-group-item:first').hasClass('node-disabled'), 'Toggle node (by id) : TreeNode has class node-disabled');
		...
		ok(!$('.list-group-item:first').hasClass('node-disabled'), 'Toggle node (by node) : TreeNode does not have class node-disabled');
	...
	test('checkNode / uncheckNode', function () {
		...
		ok($('.list-group-item:first').hasClass('node-checked'), 'Check node (by id) : TreeNode has class node-checked');
		ok(($('.node-checked').length === 1), 'Check node (by id) : There is only one checked node');
		ok($('.check-icon:first').hasClass(options.checkedIcon), 'Check node (by id) : TreeNode icon is correct');

		// Uncheck node using node id
		$tree.treeview('uncheckNode', nodeId);
		ok(!$('.list-group-item:first').hasClass('node-checked'), 'Uncheck node (by id) : TreeNode does not have class node-checked');
		ok(($('.node-checked').length === 0), 'Uncheck node (by id) : There are no checked nodes');
		ok($('.check-icon:first').hasClass(options.uncheckedIcon), 'Uncheck node (by id) : TreeNode icon is correct');

		// Check node using node
		$tree.treeview('checkNode', node);
		ok($('.list-group-item:first').hasClass('node-checked'), 'Check node (by node) : TreeNode has class node-checked');
		ok(($('.node-checked').length === 1), 'Check node (by node) : There is only one checked node');
		ok($('.check-icon:first').hasClass(options.checkedIcon), 'Check node (by node) : TreeNode icon is correct');

		// Uncheck node using node
		$tree.treeview('uncheckNode', node);
		ok(!$('.list-group-item:first').hasClass('node-checked'), 'Uncheck node (by node) : TreeNode does not have class node-checked');
		ok(($('.node-checked').length === 0), 'Uncheck node (by node) : There are no checked nodes');
		ok($('.check-icon:first').hasClass(options.uncheckedIcon), 'Uncheck node (by node) : TreeNode icon is correct');
	});
	...
	test('toggleNodeChecked', function () {
		...
		ok($('.list-group-item:first').hasClass('node-checked'), 'Toggle node (by id) : TreeNode has class node-checked');
		ok(($('.node-checked').length === 1), 'Toggle node (by id) : There is only one checked node');
		ok($('.check-icon:first').hasClass(options.checkedIcon), 'Toggle node (by id) : TreeNode icon is correct');

		// Toggle checked using node
		$tree.treeview('toggleNodeChecked', node);
		ok(!$('.list-group-item:first').hasClass('node-checked'), 'Toggle node (by node) : TreeNode does not have class node-checked');
		ok(($('.node-checked').length === 0), 'Toggle node (by node) : There are no checked nodes');
		ok($('.check-icon:first').hasClass(options.uncheckedIcon), 'Toggle node (by node) : TreeNode icon is correct');
	});
	...
	test('selectNode / unselectNode', function () {
		...
		ok($('.list-group-item:first').hasClass('node-selected'), 'Select node (by id) : TreeNode has class node-selected');
		...
		ok(!$('.list-group-item:first').hasClass('node-selected'), 'Unselect node (by id) : TreeNode does not have class node-selected');
		...
		ok($('.list-group-item:first').hasClass('node-selected'), 'Select node (by node) : TreeNode has class node-selected');
		ok(($('.node-selected').length === 1), 'Select node (by node) : There is only one selected node');

		// Unselect node using node id
		$tree.treeview('unselectNode', node);
		ok(!$('.list-group-item:first').hasClass('node-selected'), 'Unselect node (by node) : TreeNode does not have class node-selected');
	...
	test('toggleNodeSelected', function () {
		...
		ok($('.list-group-item:first').hasClass('node-selected'), 'Toggle node (by id) : TreeNode has class node-selected');
		...
		ok(!$('.list-group-item:first').hasClass('node-selected'), 'Toggle node (by id) : TreeNode does not have class node-selected');
