 ...
 * @author Eb
 */
public class RememberListTrueFalseAnswerTrueComponent implements OTS.Aig.ITestItemGenerationComponent  {
    ...
    public RememberListTrueFalseAnswerTrueComponent(DataSource mySqlDataSource) {
    ...
    public String ConstructStimulus() {
        String stimulus="";
       String template="An %s is an abstract data type which can be"
               + " implemented by concreate data structures";
