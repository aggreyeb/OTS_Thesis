 ...
 * @author Eb
 */
public class UnderstandAllPerformaceAnalysisComponent implements OTS.Aig.ITestItemGenerationComponent  {
    ...
    public UnderstandAllPerformaceAnalysisComponent(DataSource mySqlDataSource) {
    ...
    public String ConstructStimulus() {
        String stimulus="";
       String template="A %s want to do performance analysis after  designing "
               + "and implementing %s data structure.";
    ...
    public String PrepareStem() {
        String stemTemplate="Which of the following performance analysis should the %s perform";
        stemTemplate+=" I: Correctness II: Time Complexity  III: Space Complexity";
    ...
    public List<AnswerOption> CreateAnswerOptions(){
      ...
      String correctAnswer ="I,II,III";
      List<String> answerOptions=new ArrayList();
      answerOptions.add("I");
      answerOptions.add("II");
      answerOptions.add("III");
      answerOptions.add("I,II,III");
