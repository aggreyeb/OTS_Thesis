 ...
 * @author Eb
 */
public class UnderstandSpaceComplexityPerformaceAnalysisComponent implements OTS.Aig.ITestItemGenerationComponent  {
    ...
    public UnderstandSpaceComplexityPerformaceAnalysisComponent(DataSource mySqlDataSource) {
    ...
    public String ConstructStimulus() {
        String stimulus="";
       String template="A %s is considering implementing a %s data structure "
               + " which implements %s inteface for a %s.";
        
       selectedActor=SelectActor();
       String dataStructure=conceptNode.Name;
       String theInterface =conceptNode.ParentName;
       String softawareType=SelectSoftwareType();
      stimulus= String.format(template,
              selectedActor,dataStructure,
              theInterface,softawareType);
    ...
    public String PrepareStem() {
        String stemTemplate="Select the best performance analysis "
                + " the %s has to perform to ensure that the algorithem of each"
                + " method implemented has reasonably memory usage";
    ...
    public List<AnswerOption> CreateAnswerOptions(){
      ...
      String correctAnswer ="Space Complexity";
