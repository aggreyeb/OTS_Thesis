 ...
 * @author Eb
 */
public class UnderstandCorrectnessPerformaceAnalysisComponent implements OTS.Aig.ITestItemGenerationComponent  {
    ...
    public UnderstandCorrectnessPerformaceAnalysisComponent(DataSource mySqlDataSource) {
    ...
    public String ConstructStimulus() {
        String stimulus="";
       String template="A %s was asked to implement %s to be used as data "
               + " storage for a %s.";
    ...
    public String PrepareStem() {
        String stemTemplate="Choose the best analysis "
                + " the %s has to do to ensure that all the methods implements"
                + " works as expected";
