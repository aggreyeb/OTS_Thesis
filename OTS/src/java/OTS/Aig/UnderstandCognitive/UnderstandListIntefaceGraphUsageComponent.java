 ...
 * @author Eb
 */
public class UnderstandListIntefaceGraphUsageComponent implements OTS.Aig.ITestItemGenerationComponent  {
    ...
    String[] dataStructureApplications= new String[]{
     "model the shortest path between the cities",
     "design maze game",
     "implement a system to optimized route between the cities",
     "model computer networks in computer science laboratory",
     "model transport networks in a big city",
    ...
    public UnderstandListIntefaceGraphUsageComponent(DataSource mySqlDataSource) {
