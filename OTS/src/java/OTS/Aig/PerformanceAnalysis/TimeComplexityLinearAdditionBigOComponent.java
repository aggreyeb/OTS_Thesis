 ...
 * @author Eb
 */
public class TimeComplexityLinearAdditionBigOComponent implements OTS.Aig.ITestItemGenerationComponent  {
    String[] actorList=new String[]{"software developer","programmer",
                                       "student"};
    //comments
    private final Components components;
    private final String id="TimeComplexity-Linear-Analyze";
    private final String name="TimeComplexity-Linear-Analyze";
    ...
    public TimeComplexityLinearAdditionBigOComponent(DataSource mySqlDataSource) {
    ...
    public String ConstructStimulus() {
       ...
       String template="A %s designed and implemented generic data structure G&lt;T&gt; for  software component"
               + " leveraging %s."
...
"			   // some  O(1) expressions\n" +
    ...
    public String PrepareStem() {
        String stemTemplate="Assuming c is constant then what is the time complexity  of  the algorithm?";
    ...
    public List<AnswerOption> CreateAnswerOptions(){
      ...
      String CorrectAnswer ="O(n)";
      String[] options=new  String[]{"O(1)","O(n^2)","O(log n)" ,"O(logLogn)"};
