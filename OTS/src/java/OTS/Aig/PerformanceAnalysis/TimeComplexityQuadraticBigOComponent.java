 ...
 * @author Eb
 */
public class TimeComplexityQuadraticBigOComponent implements OTS.Aig.ITestItemGenerationComponent  {
    String[] actorList=new String[]{"software developer","programmer",
                                       "student"};
    //comments
    private final Components components;
    private final String id="TimeComplexity-Quadratic-Analyze";
    private final String name="TimeComplexity-Quadratic-Analyze";
    ...
    public TimeComplexityQuadraticBigOComponent(DataSource mySqlDataSource) {
    ...
    public String ConstructStimulus() {
       ...
       String template="A %s is considering designing and implementing generic data structure A&lt;T&gt; for  software module\n" +
"               The specification for the data strucure is as follows:\n" +
...
"               The algorithm implemented is as follows :\n";
    ...
    public String PrepareStem() {
        String stemTemplate="Taken c as constant then what is the time complexity  of  the algorithm?";
    ...
    public List<AnswerOption> CreateAnswerOptions(){
      ...
      String CorrectAnswer ="O(n^2)";
      String[] options=new  String[]{"O(1)","O(n)","O(log n)" ,"O(logLogn)"};
