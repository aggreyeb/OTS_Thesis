 ...
 * @author Eb
 */
public class AnalyseRunningTimePolynomialComponent implements OTS.Aig.ITestItemGenerationComponent  {
    ...
    // int[] intitialDataSets= new int[]{1000};
     private final double InitialTimeSpent=10;
     private  double intitialDataSet=1000;
     private final double requiredDataSet=100000;
    
     
     
    public AnalyseRunningTimePolynomialComponent(DataSource mySqlDataSource) {
    ...
    public String ConstructStimulus() {
        String stimulus="";
       String template="An algorithm a  %s implemented for one of the methods of %"
    ...
    public String PrepareStem() {
        String stemTemplate="How much time will be spent to process %s if"
                + " computer processing T(n) of the algorithem as as function"
                + " of time complextiy O(f(n) is defined as T(n)=cn^3 where "
                + " c is constant";
   ...
   protected  Map CalculateRunningTime(){
       Map map= new HashMap();
        ...
        //Subsititute 2 in 1
         ...
         double requiredTimeSpent=InitialTimeSpent/(intitialDataSet *intitialDataSet *intitialDataSet) *requiredDataSet * requiredDataSet *requiredDataSet ;
