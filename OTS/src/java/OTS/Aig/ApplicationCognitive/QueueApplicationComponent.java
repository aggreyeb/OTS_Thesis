 ...
 * @author Eb
 */
public class QueueApplicationComponent implements OTS.Aig.ITestItemGenerationComponent  {
    ...
    public QueueApplicationComponent(DataSource mySqlDataSource) {
    ...
    public String ConstructStimulus() {
       ...
       String template="A %s implemented generic Queue&#60;T&#62;"
      ...
      switch(buildOption){
          ...
          for(int i=0;i<inputLength;i++){
           ...
           if(function.equals("peek()")){
                correctAnswer=q.peek();
                operationSequence+="s.peek()\n";
                functionInvoked="peek()";
            }
           ...
           if(function.equals("poll()")){
                correctAnswer=q.poll();
                operationSequence+="s.poll()\n";
                functionInvoked="poll()";
            }
            break;
         ...
         int length=4;
          ...
          for(int i=0;i<length;i++){
           ...
           if(function.equals("peek()")){
                correctAnswer=queue.peek();
                operationSequence+="s.peek()\n";
                functionInvoked="peek()";
            }
            
           if(function.equals("remove()")){
                correctAnswer=queue.remove();
                operationSequence+="s.remove()\n";
                functionInvoked="remove()";
            }
           
           if(function.equals("poll()")){
                correctAnswer=queue.poll();
                operationSequence+="s.poll()\n";
                functionInvoked="poll()";
            }
