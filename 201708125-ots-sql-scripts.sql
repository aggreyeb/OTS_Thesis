...
-- Dumping data for table otsdb.conceptschema: ~12 rows (approximately)
...
-- Dumping data for table otsdb.courseknowledgemap: ~1 rows (approximately)
...
REPLACE INTO `courseknowledgemap` (`CourseKnowledgeMapId`, `CourseId`, `KnowledgeMapId`) VALUES
	('58268d0f-3e18-4099-bc81-dfa5c4524a40', 'abcba74a-db14-41f7-93dc-7b22c38cfba5', '928fc2f8-c965-4e9f-a085-bd6b80f84af6');
...
-- Dumping data for table otsdb.questionbankansweroption: ~4 rows (approximately)
